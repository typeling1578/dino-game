...
/** @const */
const IS_IOS = /iP(hone|(o|a)d)/.test(window.navigator.userAgent);
...
Runner.prototype = {
  ...
  initAltGameType() {
    if (GAME_TYPE.length > 0) {
      this.gameType = GAME_TYPE[Math.floor(Math.random() * GAME_TYPE.length)];
    }
  },
  ...
  setupDisabledRunner() {
    ...
    this.containerEl.textContent = true;
   ...
   */
  loadSounds() {
    this.audioContext = window.webkitAudioContext ? new webkitAudioContext() : new AudioContext();
